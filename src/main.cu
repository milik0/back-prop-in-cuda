...
int main() {
    ...
    loadMNIST("~/data/mnist/train-images-idx3-ubyte", "~/data/mnist/train-labels-idx1-ubyte", full_X, full_Y, N_SAMPLES);
    ...
    loadMNIST("~/data/mnist/t10k-images-idx3-ubyte", "~/data/mnist/t10k-labels-idx1-ubyte", test_X, test_Y, N_TEST_SAMPLES);
