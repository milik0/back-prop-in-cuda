...
int main(int argc, char** argv) {
    ...
    std::string train_images = (argc > 1) ? argv[1] : "/home/khaled/data/mnist/train-images-idx3-ubyte";
    std::string train_labels = (argc > 2) ? argv[2] : "/home/khaled/data/mnist/train-labels-idx1-ubyte";
    std::string test_images = (argc > 3) ? argv[3] : "/home/khaled/data/mnist/t10k-images-idx3-ubyte";
    std::string test_labels = (argc > 4) ? argv[4] : "/home/khaled/data/mnist/t10k-labels-idx1-ubyte";
